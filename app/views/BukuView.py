...
def daftarBukus():
    titles = "DAFTAR BUKU"
    judul = "Daftar Buku"
    subjudul = "Daftar Buku | Digital Library Universitas Teknologi Yogyakarta"
...
def tambahBukus():
    ...
    judul = "Tambah Buku"
    subjudul = "Tambah Buku | Digital Library Universitas Teknologi Yogyakarta"
...
def ubahDaftarBukus(id):
    ...
    subjudul = "Ubah Daftar Buku | Digital Library Universitas Teknologi Yogyakarta"
    buttontambah = "Tambah Data Buku"
    if 'email' in session:
        if request.method == 'POST':
            id = request.form['id']
