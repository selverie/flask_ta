...
def daftarMembers():
    ...
    judul = "Daftar Member"
    subjudul = "Daftar Member | Digital Library Universitas Teknologi Yogyakarta"
...
def tambahMembers():
    ...
    judul = "Tambah Member"
    subjudul = "Tambah Member | Digital Library Universitas Teknologi Yogyakarta"
...
def ubahDaftarMembers(id):
    ...
    subjudul = "Ubah Daftar Member | Digital Library Universitas Teknologi Yogyakarta"
    buttontambah = "Tambah Data Member"
    if 'email' in session:
        if request.method == 'POST':
            tipe = request.form['tipe']
